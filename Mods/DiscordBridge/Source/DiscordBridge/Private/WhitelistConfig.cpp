...
void FWhitelistConfig::RestoreDefaultConfigIfNeeded()
{
	...
	// Check for both '; ' (current standard INI) and '# ' (legacy) comment
	// markers so that configs from any version are recognised and preserved.
	if (PF.FileExists(*PrimaryPath))
	{
		FString Existing;
	...
	const FString Template =
		...
		TEXT("\n")
		TEXT("; \u2500\u2500 VERIFICATION / ACCOUNT LINKING \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\n")
		TEXT("\n")
