...
| [Third-Party Libraries](13-ThirdPartyLibraries.md) | Bundling external C++ libraries as a UBT ThirdParty module inside an Alpakit mod plugin (directory layout, Build.cs, uplugin wiring, platform guards) (developers) |
