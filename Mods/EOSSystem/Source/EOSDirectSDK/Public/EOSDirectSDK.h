 ...
 * ║                                                                          ║
 * ║  This distinction has caused repeated breakage (PRs #113 → #118).      ║
...
inline EOS_HPlatform GetPlatformHandle()
{
    ...
    // CSS UE5.3.2: use GetPlatformHandles() (NOT GetAllPlatformHandles —
    // that method does not exist in the CSS engine and causes C2039).
